            ...
            <div class="body">
                <form class="form-validation" method="post" >
                    ...
                    <div class="input-group form-group form-float">
                        ...
                        <div class="form-line">
                            <input type="email" class="form-control" name="email" value="haitunhv@163.com" maxlength="50" placeholder="邮箱" required autofocus>
                        </div>
                    </div>
                    <div class="input-group form-group">
                        ...
                        <div class="form-line">
                            ...
                            <input id="originPassword" type="password" class="form-control"  value="666" maxlength="20"placeholder="密码" required>
                        </div>
                    </div>
