                ...
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="card">
                        ...
                        <div class="body table-responsive">
                            ...
                            <c:if test="${not empty companyArr}">
                                <table class="table table-bordered table-hover table-striped">
                                    ...
                                    <form id="remove-form" action="${ctx}/company/remove" method="post">
                                        <c:forEach items="${companyArr}" var="company">
                                            <tr>
                                                <td>
                                                    <div class="switch">
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form class="form-validation" enctype="multipart/form-data" action="${ctx}/company/save" method="post">
